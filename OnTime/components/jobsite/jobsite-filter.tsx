...
type JobsiteFilterProps = {
  onApply: (filters: any) => void;
  onModalVisibleChange: (visible: boolean) => void;
};

const JobsiteFilter: React.FC<JobsiteFilterProps> = ({ onApply, onModalVisibleChange }) => {
  ...
  const applyFilters = () => {
    onApply({ name: nameFilter, city: cityFilter });
        ...
        >
          <View style={styles.modalView}>
            <View style={styles.modalHeader}>
              ...
              <MyText style={styles.modalTitle}>Filter Jobsites</MyText>
              <TouchableHighlight
                onPress={() => {
                  setNameFilter('');
                  setCityFilter('');
